...
REPO=/data/sunkaixuan/sunkaixuan_subdir/all_libs/pypto-lib-hcpre-control-20260803
PYPTO_ROOT=/data/sunkaixuan/sunkaixuan_subdir/all_pyptos/pypto-moe-ep8-20260729
EXPECTED_COMMIT=40f0643e536342e4b0a3ec3c13d4b6c9d10bbe1a
...
echo "hc_pre_linear_ok=4 reduction=atomic"
echo "bench_rounds=$PYPTO_BENCH_ROUNDS warmup=$PYPTO_BENCH_WARMUP raw=$PYPTO_BENCH_RAW"
exec /data/sunkaixuan/sunkaixuan_subdir/pypto-lib/.venv/bin/python \
